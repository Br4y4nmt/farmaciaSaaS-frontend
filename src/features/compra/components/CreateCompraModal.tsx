...
export default function CreateCompraModal({
  ...
  async function validateSection(section: ActiveSection) {
  ...
  async function validateBeforeGoToSection(section: ActiveSection) {
    if (section === 'datos') {
      setActiveSection('datos')
      return
    }

    const datosValidos = await validateSection('datos')
    ...
    const productosValidos = await validateSection('productos')
          ...
          <div className="border-b border-slate-200">
            <div className="flex gap-6 overflow-x-auto">
              ...
              <TabButton
                ...
                onClick={() => validateBeforeGoToSection('productos')}
              />

              <TabButton
                label="Resumen"
                active={activeSection === 'resumen'}
                onClick={() => validateBeforeGoToSection('resumen')}
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 flex flex-col gap-1">
                <label className="flex items-center gap-1.5 text-[13px] font-medium text-[#606266]">
                  ...
                  <InfoTooltip text="Comentario sobre la compra. Ejemplo: mercadería recibida completa, compra con descuento o entrega parcial." />
                </label>
