...
export default function CreateMarcaModal({
  isOpen,
  onClose,
  onSuccess,
}: Props) {
  const user = useStoredUser()
  const { createMarca, isLoading, error } = useCreateMarca()
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await createMarca({
    ...
    showSuccessToast(
      ...
      'La marca fue registrada con éxito'
    )
