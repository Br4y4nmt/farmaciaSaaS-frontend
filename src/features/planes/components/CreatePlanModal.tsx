...
export function CreatePlanModal({
  ...
  const [incluyeReportes, setIncluyeReportes] = useState(true)
            ...
            <div>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <input
                  ...
                  onChange={(event) => setMaxComprobantesMensuales(event.target.value)}
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <label className="flex items-center gap-2 rounded border border-slate-200 px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    onChange={(event) => setIncluyeSoporte(event.target.checked)}
                  />
                  Soporte
                </label>
                ...
                <label className="flex items-center gap-2 rounded border border-slate-200 px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    onChange={(event) => setIncluyeFacturacion(event.target.checked)}
                  />
                  Facturación
                </label>
                ...
                <label className="flex items-center gap-2 rounded border border-slate-200 px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    onChange={(event) => setIncluyeReportes(event.target.checked)}
                  />
                  Reportes
                </label>
                ...
                <label className="flex items-center gap-2 rounded border border-slate-200 px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    onChange={(event) => setIncluyeMultiSucursal(event.target.checked)}
                  />
                  Multi-sucursal
                </label>
                ...
                <label className="flex items-center gap-2 rounded border border-slate-200 px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    onChange={(event) => setIncluyeBackup(event.target.checked)}
                  />
                  Backup
                </label>
              </div>
