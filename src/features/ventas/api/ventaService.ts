...
export const ventaService = {
  async createVentaRapida(
    payload: CreateVentaRapidaPayload
  ): Promise<VentaRapidaResponse> {
    const response = await fetch(`${API_URL}/ventas/venta-rapida`, {
      method: 'POST',
      headers: {
